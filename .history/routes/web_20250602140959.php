...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::delete('/cart/delete', [transaksiController::class, 'delete'])->name('deleteFromCart');
    Route::post('/checkout', [Controller::class, 'store'])->name('checkout');
    Route::delete('/checkout', [transaksiController::class, 'destroy'])->name('checkout');
