...
public function notificationHandler(Request $request)
{
    ...
    Log::info("Callback received for order: " . $order_id . " with status: " . $transaction);

    $order = Transaction::where('id_transaksi', $order_id)->first();

    if (!$order) {
        Log::error("Order ID not found: " . $order_id);
